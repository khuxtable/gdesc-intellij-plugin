...
@Data
public class ObjectDirectiveSubtree extends IdentifierDefSubtree implements GDescDirectiveElement {

	public ObjectDirectiveSubtree(@NotNull ASTNode node, @NotNull IElementType idElementTyp) {
