...
@Data
public class TextDirectiveSubtree extends IdentifierDefSubtree implements GDescDirectiveElement {

	private boolean fragment;

	public TextDirectiveSubtree(@NotNull ASTNode node, @NotNull IElementType idElementTyp, boolean fragment) {
