...
@Data
public class VariableDirectiveSubtree extends IdentifierDefSubtree implements GDescDirectiveElement {

	public VariableDirectiveSubtree(@NotNull ASTNode node, @NotNull IElementType idElementTyp) {
