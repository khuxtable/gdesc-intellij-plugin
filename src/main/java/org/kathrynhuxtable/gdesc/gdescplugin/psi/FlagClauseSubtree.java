...
@Data
public class FlagClauseSubtree extends IdentifierDefSubtree implements GDescDirectiveElement {

	public FlagClauseSubtree(@NotNull ASTNode node, @NotNull IElementType idElementTyp) {
