...
@Data
public class StateClauseSubtree extends IdentifierDefSubtree implements GDescDirectiveElement {

	public StateClauseSubtree(@NotNull ASTNode node, @NotNull IElementType idElementTyp) {
